...
CSRF_TRUSTED_ORIGINS = ['https://8000-robindavidg-ciproject05-i1n4a7i2rxu.ws-eu73.gitpod.io']
...
if 'USE_AWS' in os.environ:
    # Cache control. Tells browser to cache static files for a long time.
